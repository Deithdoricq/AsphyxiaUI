...
---------------------------------------------------------------------------------------------------------------------------------
	...
	tdpsAnchor:SetPoint('TOP', TukuiMinimap, 'BOTTOM', 0, -47)
	tdpsAnchor:SetFrameStrata('BACKGROUND')
	tdpsAnchor:SetBackdrop({bgFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], edgeFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], tile = false, tileSize = 1, edgeSize = 1, insets = {left = 1, right = 1, top = 1, bottom = 1}})
	...
	tdpsFrame:SetBackdrop({bgFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], edgeFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], tile = false, tileSize = 1, edgeSize = 1, insets = {left = 1, right = 1, top = 1, bottom = 1}})
    ...
    noData:SetFont(C.media.pixelfont, C.datatext.fontsize,C.datatext.fontflag) -- setting font, size and outline
	noData:SetShadowColor(.1, .1, .1, 1)
	noData:SetShadowOffset(tdpsFont.shadow, tdpsFont.shadow * -1)
    noData:SetText(T.StatColor.."TinyDPS") -- color like datatext
...
---------------------------------------------------------------------------------------------------------------------------------
	...
	local function newBar(g)
		...
		dummybar:SetBackdrop({bgFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], edgeFile = [[Interface\AddOns\TinyDPS\Textures\wglass.tga]], tile = false, tileSize = 1, edgeSize = 1, insets = { left = 0, right = 0, top = 0, bottom = 0}})
