	...
	["MAGE"] = {
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "CENTER", UIParent, "CENTER", 0, -125},

			-- Frostbite
			--{ spellID = 11071, size = 47, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Winter's Chill
			{ spellID = 28593, size = 50, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Fingers of Frost
			{ spellID = 44544, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Fireball!
			{ spellID = 57761, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Hot Streak
			{ spellID = 44445, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Missile Barrage
			{ spellID = 54486, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Clearcasting
			{ spellID = 12536, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Impact
			{ spellID = 12358, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
		},
		{
			Name = "T_DEBUFF_ICON",
			Direction = "RIGHT",
			Interval = 4,
			Mode = "ICON",
			setPoint = { "LEFT", TukuiTarget, "RIGHT", 5, 3 },
	...
	["PRIEST"] = {
		{
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "RIGHT", TukuiPlayer, "LEFT", -67, 3 },

			-- Haste on Greater Heal
		...
		},
		{
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "RIGHT", TukuiPlayer, "LEFT", -80, 80 },

			-- Chakra
			{ spellID = 14751, size = 34, filter = "CD" },
			-- Wings
			{ spellID = 47788, size = 34, filter = "CD" },
			-- POM
			{ spellID = 33076, size = 34, filter = "CD" },
			-- Well
			{ spellID = 724, size = 34, filter = "CD" },
			-- Circle of Healing
			{ spellID = 34861, size = 34, filter = "CD" },
			-- Gil Anthem
			{ spellID = 64843, size = 34, filter = "CD" },
			-- Mans Anthem
			{ spellID = 64901, size = 34, filter = "CD" },
			-- Pet
			{ spellID = 34433, size = 34, filter = "CD" },
			-- Puddle
			{ spellID = 88685, size = 34, filter = "CD" },
		},
		{
			Name = "DEBUFF_FOCUS",
			Direction = "RIGHT",
			...
			-- Shackle
			{ spellID = 9484, size = 31, unitId = "focus", caster = "player", filter = "DEBUFF" },
		},
		{
			Name = "T_DEBUFF_ICON",
			Direction = "RIGHT",
	...
	["ALL"] = {
		{
			...
			-- Lightning Conductor (omnitron)
			{ spellID = 91431, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Static Shock (alakir)
			{ spellID = 87873, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Twilight meteorite
			{ spellID = 86013, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Eclipse
			{ spellID = 92878, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Lighting-Conductor
			{ spellID = 93295, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Промокший насквозь
			{ spellID = 82762, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Frostbite Heart
			{ spellID = 82665, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Burning Blood
			{ spellID = 82660, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Devouring fire
			{ spellID = 92973, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Mucus-hit
			{ spellID = 88917, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Excess Predictions
			{ spellID = 95639, size = 52, unitId = "player", caster = "all", filter = "DEBUFF" },
		},
	},
	["WARLOCK"] = {
		{
			...
			{ spellID = 70840, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Improved Soul Fire
			{ spellID = 85114, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Molten Core
			{ spellID = 47383, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Decimation
			{ spellID = 63158, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Backdraft
			{ spellID = 54277, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Backlash
			{ spellID = 34939, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Nether Protection
			{ spellID = 30301, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Nightfall
			{ spellID = 18095, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
			-- Burning Soul
			{ spellID = 74434, size = 50, unitId = "player", caster = "player", filter = "BUFF" },
		},
		
		{
			...
			-- Soulfire
			{ spellID = 85383, size = 65, unitId = "player", caster = "player", filter = "BUFF" },	
			-- 4set buff
			{ spellID = 89937, size = 65, unitId = "player", caster = "player", filter = "BUFF" },
			-- Eradication
			{ spellID = 64371, size = 65, unitId = "player", caster = "player", filter = "BUFF" },			
		},
		{
			Name = "COOLDOWN",
			Direction = "RIGHT",
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "RIGHT", TukuiPlayer, "LEFT", -63, 210 },
	...
	["ALL"] = {
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "TOP", TukuiPlayer, "RIGHT", -11, 51 },
		...
		},
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "TOP", TukuiPlayer, "RIGHT", -31, 195 },
			...
			-- Hungering Cold
			{ spellID = 51209, size = 65, unitId = "player", caster = "all", filter = "DEBUFF" },
			...
			--{ spellID = 60210, size = 65, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Scare Beast
